...
- `@vaultkeeper/cli` README: new "Doctor / preflight checks" section on checkmark semantics and always-run informational plugin checks; points at the now-self-contained library README for the full error hierarchy and config reference.
