...
export const wasmauthorization_handleId: (a: number) => [number, number];
...
export const wasmvaultkeeper_releaseHandle: (a: number, b: number, c: number) => [number, number, number];
export const wasmvaultkeeper_resolveSecretClaims: (a: number, b: number, c: number) => [number, number, number];
